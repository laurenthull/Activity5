...
class PizzaOrderApp:
    def __init__(self, master, connection):
        ...
        style_label.grid(row=len(self.size_options) + 2, column=0, sticky="w")
        ...
        crust_label.grid(row=len(self.size_options) + 3, column=0, sticky="w")
        ...
        # Total price label
        self.total_price_label = tk.Label(master, text="Total Price: $0.00", font=("Helvetica", 16))
